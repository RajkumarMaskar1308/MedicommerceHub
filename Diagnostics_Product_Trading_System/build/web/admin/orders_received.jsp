...
<html>
  ...
  <table id="keywords" cellspacing="0" cellpadding="0" style="width: 100%;" >
    ...
    <tbody>
      ...
      <%
            ...
            Statement st = null;
                            ...
                            try
                            {
                                ...
                                String sql="select * from orders where dstatus='Pending' ";
      ...
      <tr>
    <form name="orders_received" action="../orders_received" method="post">
        ...
        <td><%=total_amount%></td>
        <td><%=dstatus%></td>
        <td><input class="buttonclass" type="submit" name="submit" value="Process"></td>
    </form>
      </tr>
