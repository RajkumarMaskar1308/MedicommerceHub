        ...
        if(event.equals("submit"))
         {
             ...
             if(password.equals(cpassword))
             {
                 ...
                 {
                     String insert=db.Insert("insert into admin_signup(company_name,first_name,address_line1,city,district,pincode,gstno,accountno,password,email,last_name,address_line2,state,taluka,contact_no,bank_name,ifsc,cpassword)values('"+company_name+"','"+first_name+"','"+address_line1+"','"+city+"','"+district+"','"+pincode+"','"+gstno+"','"+accountno+"','"+password+"','"+email+"','"+last_name+"','"+address_line2+"','"+state+"','"+taluka+"','"+contact_no+"','"+bank_name+"','"+ifsc+"','"+cpassword+"')");
                     out.println(insert);
