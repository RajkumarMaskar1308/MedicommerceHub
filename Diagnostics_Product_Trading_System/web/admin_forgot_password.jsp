<%-- 
    ...
    Created on : 22 Feb, 2023, 11:10:00 PM
    Author     : prath
--%>
...
<html>
    ...
    <body>
         <form name="admin_forgot_password" action="admin_forgot_password" method="post">  
        ...
        <div class="maindiv">
            ...
            <div class="row">
                    ...
                    <div class="col-sm-6"><a class="acnchor" href="admin_login.jsp">Login</a></div>
                    <div class="col-sm-6">
                         <a class="acnchor1" href="admin_signup.jsp">Signup as Admin</a>
